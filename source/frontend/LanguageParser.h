...
public:
  ...
  class  ImportInstructionContext : public ExpressionContext {
  public:
    ImportInstructionContext(ExpressionContext *ctx);
  ...
  class  ApplicationContext : public ExpressionContext {
  public:
    ApplicationContext(ExpressionContext *ctx);
  ...
  class  AbstractionContext : public ExpressionContext {
  public:
    AbstractionContext(ExpressionContext *ctx);

    antlr4::tree::TerminalNode *Lambda();
    antlr4::tree::TerminalNode *Identifier();
    ExpressionContext *expression();
    TypeBindingContext *typeBinding();
    virtual void enterRule(antlr4::tree::ParseTreeListener *listener) override;
    virtual void exitRule(antlr4::tree::ParseTreeListener *listener) override;
  ...
  class  PrintInstructionContext : public ExpressionContext {
  public:
    PrintInstructionContext(ExpressionContext *ctx);
  ...
  class  BracketsContext : public ExpressionContext {
  public:
    BracketsContext(ExpressionContext *ctx);
  ...
  class  TypeBindingContext : public antlr4::ParserRuleContext {
  public:
    TypeBindingContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    TypeContext *type();
  ...
  class  LeafTypeContext : public TypeContext {
  public:
    LeafTypeContext(TypeContext *ctx);
  ...
  class  NodeTypeContext : public TypeContext {
  public:
  ...
  class  TypeBracketsContext : public TypeContext {
  public:
    TypeBracketsContext(TypeContext *ctx);
